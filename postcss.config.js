// Used by the Gruvbox theme (css.PostCSS). Copied from the theme with the import path pointed at _vendor/.
  ...
  plugins: [
    postcssImport({
      path: [
        ...
        path.posix.join(import.meta.dirname, "_vendor", "github.com", "schnerring", "hugo-theme-gruvbox", "assets", "css"),
      ],
    }),
    postcssUrl([
      {
